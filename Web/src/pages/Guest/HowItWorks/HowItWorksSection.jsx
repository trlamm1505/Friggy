    ...
    <section id="how-it-works" className="py-24 bg-gradient-to-b from-emerald-50/60 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-800 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider shadow-xs border border-emerald-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl bg-gradient-to-br from-emerald-100/90 via-emerald-50 to-white text-emerald-950 p-8 shadow-xl border border-emerald-200/80 overflow-hidden">
                  ...
                  >
                    ...
                    <div className="space-y-3 pt-2">
                      {currentStepData.previewDetails.map((detail, idx) => (
                        <div
                          key={idx}
                          className="bg-white/90 p-3.5 rounded-2xl border border-emerald-200/80 text-sm font-semibold text-emerald-950 flex items-center justify-between gap-3 shadow-xs"
                        >
                          <span>{detail}</span>
                    ...
                    <div className="pt-4 flex items-center justify-between text-xs text-emerald-700 font-medium">
